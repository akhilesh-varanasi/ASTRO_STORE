          ...
          <h1>Products</h1>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="price" placeholder="Enter Product Price" value="<?php echo $final['price']?>" name="price">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea id="description" class="form-control" rows="10" placeholder="Enter Product Description" value="<?php echo $final['description']?>" name="description"></textarea>
                </div>
                <div class="form-group">
